 ...
 * 
 * INSTALLATION:
 * 1. Copy this code (WITHOUT the <?php tag)
 * 2. Paste at the BOTTOM of your existing functions.php file
 * 3. Upload the CSS and JS files to your theme
 * 4. Create radio shows in WordPress admin
 * 5. Use shortcode [radio_schedule] anywhere
 */
